<template>
  <a
    ...
    <span>
      <p class="extra-info">Guia completo para</p>
      <p class="heading">Dominar a Pinia</p>
      <p class="extra-info">escrito pelo seu criador</p>
    </span>
  </a>
  <a
    class="banner"
    ...
    target="_blank">
    <img src="/banners/vuejs-certification.svg" alt="Certificação da Vue.js">
  </a>
</template>
